...
const common_greetings = /(^hello|^hllo|^hi|^hey|^hola|^sup|^yo|^ola|^howdy|^alright)\b\s?.*$/i;
const common_greetings_negative = /(?!(^hello|^hi|^hey|^hllo|^sup|^hola|^yo|^ola|^howdy)\b)\w+/i;
